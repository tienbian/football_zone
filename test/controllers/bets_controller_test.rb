...
class BetsControllerTest < ActionController::TestCase
  ...
  test "should create bet" do
    assert_difference('Bet.count') do
      post :create, bet: { away_team_score: @bet.away_team_score, home_team_score: @bet.home_team_score }
    end
  ...
  test "should update bet" do
    patch :update, id: @bet, bet: { away_team_score: @bet.away_team_score, home_team_score: @bet.home_team_score }
    assert_redirected_to bet_path(assigns(:bet))
  end
